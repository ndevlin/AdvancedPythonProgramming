...
'''
Sockets Testing File to test communication between Client and Server
June 3 2024
'''
...
import unittest
import time
from Client_RefactorJune3 import Client
...
class TestSockets(unittest.TestCase):
    ...
    def testSendBinaryFile(self):
        ...
        with open("testBinaryFile.bin", 'rb') as sent_file, open("receivedBinaryFile.bin", 'rb') as received_file:
            ...
            print("Send Binary File Test Passed")
            print()
...
And by opposing end them."""
        time.sleep(5) # Wait for the server to finish writing the file
        with open("receivedTextFile.txt", 'r') as receivedFile:
            ...
            print("Send Text File Test Passed")
            print()
